    ...
    return(
        <div className="flex flex-col items-center w-full h-[100vh] overflow-auto p-5 dark:bg-gray-800">
            <div className="flex gap-5 justify-end w-full mb-15">
                <div className="flex justify-center items-center rounded-2xl w-[90%]">
                    <Input />
                    <Button
                        text={'ADD'}
                        onClickHandler={handleAddItem}
                        customCSS="hover:bg-gray-400 dark:hover:bg-gray-500 hover:ease-in-out transition-colors "
                    />
                </div>
                <label className="swap swap-rotate w-[50px] dark:text-white">
